...
operation::query-events[snippets='request-parameters,http-request,response-fields,curl-request,http-response,links,response-headers']
...
operation::get-an-event[snippets='curl-request,http-request,http-response,response-fields,response-headers,links']
